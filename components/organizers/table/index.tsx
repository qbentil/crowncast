    ...
    return (
        <div className='w-full py-3 my-4 bg-white shadow-sm'>
            ...
            <div className='flex items-center justify-start gap-x-2'>
                <h1 className='text-lg font-bold'>Organizers</h1>
                <span className='bg-primary-50 text-primary-700 rounded px-4 py-1 text-sm'>1 organizer(s)</span>
            </div>
            {/* table */}
                ...
                <table className='w-full border-collapse hover'>
                    <thead>
                        <tr className='font-normal bg-gray-200 text-gray-500 text-sm '>
                            ...
                            <td className='border border-gray-300 p-2'>Company</td>
                            <td className='border border-gray-300 p-2'>Date Joined</td>
                            <td className='border border-gray-300 p-2 text-center'>Actions</td>
                        </tr>
                    </thead>
                    <tbody>
                        <tr className='text-sm text-gray-500'>
                            <td className='border border-gray-200 p-2'>Sandra Akubah Darko</td>
                            <td className='border border-gray-200 p-2'>s.akubahd@st.ugedu.gh</td>
                            ...
                            <td className='border border-gray-200 p-2'>14th Feb, 2023</td>
